...
$("#form-add-to-cart").submit(function (event) {
    ...
    if (submitter && submitter.hasAttribute('data-buy-now')) {
        return  ;
    }
    var form = $(this);
    ...
    if (form[0].checkValidity() === false || hasCheckboxGroupError) {
        ...
        event.preventDefault();
        $('#form-add-to-cart .btn-product-cart .btn-cart-icon').prop('disabled', true);
            ...
            success: function (response) {
                if (response.result == 1) {
                    setTimeout(function () {
                        ...
                        $('#form-add-to-cart .btn-add-to-cart').html('<i class="icon-check"></i>' + MdsConfig.text.addedToCart);
                    ...
                    setTimeout(function () {
                        $('#form-add-to-cart .btn-add-to-cart').html('<span class="btn-cart-icon"><i class="icon-cart-solid"></i></span>' + MdsConfig.text.addToCart);
                        $('#form-add-to-cart .btn-add-to-cart').prop('disabled', false);
                    }, 1000);
                } else {
                    $('#form-add-to-cart .btn-add-to-cart').html('<span class="btn-cart-icon"><i class="icon-cart-solid"></i></span>' + MdsConfig.text.addToCart);
                    $('#form-add-to-cart .btn-add-to-cart').prop('disabled', false);
...
$(document).on('click', '.btn-item-add-to-cart', function () {
    ...
    var $btn = $('#btn_add_cart_' + buttonId);
