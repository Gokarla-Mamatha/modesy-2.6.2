...
$(document).ready(function () {
    ...
    function updateListingTypes(selected) {
        if (selected == 'digital') {
            $('.listing_sell_on_site').show();
            $('.listing_ordinary_listing').hide();
            $('.listing_bidding').hide();
            $('.listing_license_keys').show();
            $('.listing_coupon').hide();
            $('.listing_productbid').hide();

        } else if (selected == 'coupon') {
            $('.listing_sell_on_site').hide();
            $('.listing_ordinary_listing').hide();
            $('.listing_bidding').hide();
            ...
            $('.listing_license_keys').hide();
            $('.listing_coupon').hide();
            $('.listing_productbid').show();
        }
    }

    $('input[type=radio][name=product_type]').change(function () {
        $('input[name=listing_type]').prop('checked', false);
        updateListingTypes(this.value);
    });

    updateListingTypes($('input[name=product_type]:checked').val());
