...
function getStates(countryId, type = '') {
    ...
    $('#select_states' + suffix).empty();
    $('#select_cities' + suffix).empty();

    $('#get_states_container' + suffix).hide();
    $('#get_cities_container' + suffix).hide();
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.result == 1) {
                $('#select_states' + suffix).html(response.content);
                $('#get_states_container' + suffix).show();
            } else {
                $('#select_states' + suffix).html('');
                $('#get_states_container' + suffix).hide();
            }
        }
    });
...
//get cities
function getCities(stateId, type = '') {
    let suffix = type ? '_' + type : '';
    $.ajax({
        type: 'POST',
        ...
        success: function (response) {
            if (response.result == 1) {
                $('#select_cities' + suffix).html(response.content);
                $('#get_cities_container' + suffix).show();
            } else {
                $('#select_cities' + suffix).html('');
                $('#get_cities_container' + suffix).hide();
            }
        }
    });
