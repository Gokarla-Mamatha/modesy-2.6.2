...
public function isCouponAssignedToProduct($couponId, $productId)
    {
        return $this->db->table('coupon_products')
...
public function productHasCoupon($productId)
{
    $row = $this->db->table('coupon_products')
        ->where('product_id', $productId)
        ->get()
        ->getRow();
...
public function hasAnyActiveCouponByProduct($productId)
{
