...
class SettingsModel extends BaseModel
{
    ...
    public function updateSettings()
    {
        $data = [
            ...
            'loyalty_convert_points' => inputPost('loyalty_convert_points'),
            'loyalty_convert_amount' => inputPost('loyalty_convert_amount'),
            'referral_points' => inputPost('referral_points')
        ];
    ...
    public function updatePreferences($form)
    {
        if ($form == 'homepage') {
            ...
            $couponProductsSystem = inputPost('coupons_products_system');
            if (empty($physicalProductsSystem) && empty($digitalProductsSystem) && empty($couponProductsSystem)) {
            ...
            $data = [
                ...
                'coupons_products_system' => $couponProductsSystem,
