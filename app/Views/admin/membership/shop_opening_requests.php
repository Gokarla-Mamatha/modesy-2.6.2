                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 100px;">
                                            <?php if ($user->is_active_shop_request == 1): ?>
                                                ...
                                                <?php endif; ?>
                                                <div class="m-t-5">
                                                    <button type="submit" class="btn btn-info btn-xs" data-bs-toggle="modal" data-bs-target="#modalReason<?= $user->id; ?>"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<?= trans("show_reason"); ?></button>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-default" data-bs-dismiss="modal"><?= trans("close"); ?></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <td>
                                            <form action="<?= base_url('Membership/approveShopOpeningRequest'); ?>" method="post">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn bg-purple dropdown-toggle btn-select-option" type="submit" data-bs-toggle="dropdown"><?= trans('select_option'); ?>
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <?php if ($user->is_active_shop_request != 2): ?>
                                                            <li>
                                                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalReject" onclick="$('#reject_user_id').val(<?= $user->id; ?>);"><i class="fa fa-ban option-icon"></i><?= trans("reject"); ?></a>
                                                            </li>
                                                        <?php endif;
                                                        if ($user->is_active_shop_request != 3): ?>
                                                            <li>
                                                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalRejectPermanently" onclick="$('#reject_permanently_user_id').val(<?= $user->id; ?>);"><i class="fa fa-ban option-icon"></i><?= trans("reject_permanently"); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                    </ul>
                                                </div>
