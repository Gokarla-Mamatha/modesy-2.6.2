        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row table-filter-container">
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-default filter-toggle collapsed m-b-10" data-bs-toggle="collapse" data-bs-target="#collapseFilter" aria-expanded="false">
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 100px;">
                                            <?php if ($user->is_active_shop_request == 1): ?>
                                                ...
                                                <?php endif; ?>
                                                <div class="m-t-5">
                                                    <button type="submit" class="btn btn-info btn-xs" data-bs-toggle="modal" data-bs-target="#modalReason<?= $user->id; ?>"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<?= esc(trans("show_reason")); ?></button>
                                                    <div id="modalReason<?= $user->id; ?>" class="modal fade" tabindex="-1">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <button type="submit" class="btn-close" data-bs-dismiss="modal"><i class="icon-close"></i></button>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-default" data-bs-dismiss="modal"><?= esc(trans("close")); ?></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <td>
                                            <form action="<?= base_url('Membership/approveShopOpeningRequest'); ?>" method="post">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn bg-purple dropdown-toggle btn-select-option" type="submit" data-bs-toggle="dropdown"><?= esc(trans('select_option')); ?>
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <?php if ($user->is_active_shop_request != 2): ?>
                                                            <li>
                                                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalReject" onclick="$('#reject_user_id').val(<?= $user->id; ?>);"><i class="fa fa-ban option-icon"></i><?= esc(trans("reject")); ?></a>
                                                            </li>
                                                        <?php endif;
                                                        if ($user->is_active_shop_request != 3): ?>
                                                            <li>
                                                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalRejectPermanently" onclick="$('#reject_permanently_user_id').val(<?= $user->id; ?>);"><i class="fa fa-ban option-icon"></i><?= esc(trans("reject_permanently")); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                    </ul>
                                                </div>
...
<?php if (!empty($users)):
    foreach ($users as $user): ?>
        <div id="modalDetails<?= $user->id; ?>" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="submit" class="btn-close" data-bs-dismiss="modal">&times;</button>
...
<div id="modalRejectPermanently" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('Membership/rejectShopOpeningRequest'); ?>" method="post">
                <?= csrf_field(); ?>
