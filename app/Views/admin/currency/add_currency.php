    ...
    <div class="col-lg-8 col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title"><?= esc(trans("add_currency")); ?></h3>
                </div>
                <div class="right">
            ...
            <form action="<?= base_url('Admin/addCurrencyPost'); ?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Ex: US Dollar" maxlength="200" data-type="text" required>
                    </div>
                    <div class="form-group">
                        <label><?= esc(trans("currency_code")); ?></label>
                        <input type="text" class="form-control" name="code" placeholder="Ex: USD" maxlength="99" data-type="text" required>
                    </div>
                    <div class="form-group">
                        <label><?= esc(trans("currency_symbol")); ?></label>
                        <input type="text" class="form-control" name="symbol" placeholder="Ex: $" maxlength="99" data-type="text" required>
                    </div>
                    <div class="form-group">
                        <label><?= esc(trans('currency_format')); ?> (Thousands Seperator)</label>
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary pull-right"><?= esc(trans('add_currency')); ?></button>
                </div>
            </form>
        </div>
    </div>
