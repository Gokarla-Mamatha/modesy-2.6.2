                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($paymentSettings->default_currency == $item->code):
                                                    echo trans("default"); ?>
                                                <?php else: ?>
                                                    <input type="number" class="form-control input-exchange-rate" value="<?= $item->exchange_rate; ?>" data-currency-id="<?= $item->id; ?>" min="0" max="999999999" step="0.00001" placeholder="<?= trans("exchange_rate"); ?>" style="width: 150px;" data-type="decimal">
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            <!-- <a href="javascript:void(0)" onclick="deleteItem('Admin/deleteCurrencyPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                            <a href="#" class="btn-item-delete" data-url="Admin/deleteCurrencyPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
