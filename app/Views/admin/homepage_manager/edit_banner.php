    ...
    <div class="col-md-12 col-lg-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title"><?= esc(trans("edit_banner")); ?></h3>
                </div>
                <div class="right">
                    <a href="<?= adminUrl('homepage-manager'); ?>" class="btn btn-success btn-add-new"><i class="fa fa-bars"></i><?= esc(trans("homepage_manager")); ?></a>
                </div>
            </div>
            ...
            <form action="<?= base_url('Admin/editIndexBannerPost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <input type="text" name="banner_url" class="form-control" value="<?= $banner->banner_url; ?>" placeholder="<?= esc(trans("banner")); ?>&nbsp;<?= esc(trans("url")); ?>" data-type="url" required>
                    </div>
                    <div class="form-group">
                        <input type="number" name="banner_order" min="1" max="9999999" value="<?= $banner->banner_order; ?>" class="form-control" placeholder="<?= esc(trans("order")); ?>" data-type="number" required>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <input type="number" name="banner_width" min="1" max="100" step="0.01" value="<?= $banner->banner_width; ?>" class="form-control" placeholder="<?= esc(trans("banner_width")); ?>&nbsp;(E.g: 50)" data-type="decimal" required>
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans("banner")); ?></label><br>
                        <img src="<?= getStorageFileUrl($banner->banner_image_path, $banner->storage); ?>" style="max-width: 320px; max-height: 320px;" class="product-img"><br><br>
