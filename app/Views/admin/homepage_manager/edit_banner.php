        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('Admin/editIndexBannerPost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <input type="text" name="banner_url" class="form-control" value="<?= $banner->banner_url; ?>" placeholder="<?= trans("banner"); ?>&nbsp;<?= trans("url"); ?>" data-type="url" required>
                    </div>
                    <div class="form-group">
                        <input type="number" name="banner_order" min="1" max="9999999" value="<?= $banner->banner_order; ?>" class="form-control" placeholder="<?= trans("order"); ?>" data-type="number" required>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <input type="number" name="banner_width" min="1" max="100" step="0.01" value="<?= $banner->banner_width; ?>" class="form-control" placeholder="<?= trans("banner_width"); ?>&nbsp;(E.g: 50)" data-type="decimal" required>
