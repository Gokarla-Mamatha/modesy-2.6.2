            ...
            <form action="<?= base_url('Category/editCategoryPost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="category_order" value="<?= esc($category->category_order); ?>" placeholder="<?= trans('order'); ?>" value="1" min="1" max="99999" data-type="number" required>
                    </div>
                    ...
                    <div class="form-group m-b-30">
                        ...
                        <?php if (!empty($category->image)): ?>
                            <!-- <a href="#" class="btn btn-sm btn-danger btn-delete-category-img" onclick="deleteCategoryImage('<?= $category->id; ?>');"><?= trans("delete"); ?></a> -->
                             <a href="#" class="btn btn-sm btn-danger btn-delete-img" data-id="<?= $category->id; ?>" data-fn="deleteCategoryImage"> <?= trans("delete"); ?></a>
                        <?php endif; ?>
