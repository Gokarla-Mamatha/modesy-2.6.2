            ...
            <div class="col-sm-12">
                ...
                <div class="table-responsive">
                                    ...
                                    <td width="20%">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                ...
                                                <li>
                                                    <!-- <a href="#" onclick="deleteItem('Admin/deleteCountryPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                    <a href="#" class="btn-item-delete" data-url="Admin/deleteCountryPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
                    ...
                    <div class="col-sm-12 table-ft">
                        <div class="row">
                            <div class="pull-left">
                                <button type="button" class="btn btn-danger btn-activate-inactivate-countries" data-action="inactivate"><?= trans("inactivate_all"); ?></button>
                                <button type="button" class="btn btn-success btn-activate-inactivate-countries" data-action="activate"><?= trans("activate_all"); ?></button>
                            </div>
