    ...
    <form action="<?= base_url('Admin/seoToolsPost'); ?>" method="post">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <textarea class="form-control text-area" name="google_analytics" placeholder="<?= trans('google_analytics'); ?>" style="min-height: 100px;" data-type="text"><?= esc($generalSettings->google_analytics); ?></textarea>
                    </div>
