                                    ...
                                    <?php if ($item->item_type == 'product'):
                                        ...
                                        <td style="width: 130px;">
                                            <div class="btn-group btn-group-option">
                                                ...
                                                <!-- <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete" onclick="deleteItem('Admin/deleteAbuseReportPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                <a href="#" class="btn-item-delete" data-url="Admin/deleteAbuseReportPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <!-- <a href="javascript:void(0)" class="btn btn-danger pull-right" onclick="deleteItem('Product/deleteReviewPost','<?= $review->id; ?>','<?= trans("confirm_review", true); ?>');"> -->
                                                                    <a href="#" class="btn-item-delete" data-url="Product/deleteReviewPost" data-id="<?= $review->id; ?>" data-msg="<?= trans('confirm_review', true); ?>">
                                                                    <?= trans('delete'); ?></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <?php elseif ($item->item_type == "comment"):
                                        ...
                                        <td style="width: 130px;">
                                            <div class="btn-group btn-group-option">
                                                    ...
                                                    <div id="modalAbuse<?= $item->id; ?>" class="modal fade" role="dialog">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <!-- <a href="javascript:void(0)" class="btn btn-danger pull-right" onclick="deleteItem('Product/deleteCommentPost','<?= $comment->id; ?>','<?= trans("confirm_comment", true); ?>');"> -->
                                                                    <a href="#" class="btn-item-delete" data-url="Product/deleteCommentPost" data-id="<?= $comment->id; ?>" data-msg="<?= trans('confirm_comment', true); ?>">
                                                                    <?= trans('delete'); ?></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <?php endif; ?>
                                                <!-- <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete" onclick="deleteItem('Admin/deleteAbuseReportPost','<?= $item->id; ?>','<?= trans("confirm_delete"); ?>');"> -->
                                                <a href="#" class="btn-item-delete" data-url="Admin/deleteAbuseReportPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
                                                <i class="fa fa-trash-can"></i></a>
                                            </div>
                                        </td>
