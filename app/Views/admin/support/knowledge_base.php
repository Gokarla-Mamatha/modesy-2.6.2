                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            <!-- <a href="javascript:void(0)" onclick="deleteItem('SupportAdmin/deleteContentPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                                <a href="#" class="btn-item-delete" data-url="SupportAdmin/deleteContentPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            <!-- <a href="javascript:void(0)" onclick="deleteItem('SupportAdmin/deleteCategoryPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                                <a href="#" class="btn-item-delete" data-url="SupportAdmin/deleteCategoryPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
                                                            <i class="fa fa-trash-can option-icon"></i><?= trans('delete'); ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
