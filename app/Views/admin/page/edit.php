            ...
            <form action="<?= base_url('Admin/editPagePost'); ?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="<?= trans('title'); ?>" value="<?= esc($page->title); ?>" data-type="title" required>
                    </div>
                    <?php if (empty($page->page_default_name)): ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="slug" placeholder="<?= trans("slug"); ?>" value="<?= esc($page->slug); ?>" data-type="slug">
                        </div>
                    <?php else: ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="description" placeholder="<?= trans("description"); ?> (<?= trans('meta_tag'); ?>)" value="<?= esc($page->description); ?>" data-type="text">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" clas s="form-control" name="page_order" placeholder="<?= trans('order'); ?>" value="<?= $page->page_order; ?>" min="1" style="max-width: 600px;" data-type="number">
                    </div>
