            ...
            <form action="<?= base_url('Admin/addPagePost'); ?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="<?= trans('title'); ?>" value="<?= old('title'); ?>" data-type="title" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="page_order" placeholder="<?= trans('order'); ?>" value="1" min="1" style="max-width: 600px;" data-type="number">
                    </div>
