                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                ...
                                                <?php if ($item->is_custom == 1): ?>
                                                    <li>
                                                        <!-- <a href="javascript:void(0)" onclick="deleteItem('Admin/deletePagePost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                            <a href="#" class="btn-item-delete" data-url="Admin/deletePagePost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_user', true); ?>">
