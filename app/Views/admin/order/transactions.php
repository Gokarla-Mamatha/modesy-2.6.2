                                ...
                                <div class="item-table-filter" style="width: 320px;">
                                    ...
                                    <div class="item-table-filter-search">
                                        ...
                                        <div class="btn-group table-export">
                                            <button type="button" class="btn btn-default dropdown-toggle btn-table-export" data-bs-toggle="dropdown"><?= trans("export"); ?>&nbsp;&nbsp;<i class="fa fa-caret-down"></i></button>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                <li>
                                                    <!-- <a href="javascript:void(0)" onclick="deleteItem('OrderAdmin/deleteTransactionPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                        <a href="#" class="btn-item-delete" data-url="OrderAdmin/deleteTransactionPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_user', true); ?>">
