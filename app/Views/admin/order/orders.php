                                        ...
                                        <form action="<?= base_url('OrderAdmin/orderPaymentReceivedPost'); ?>" method="post">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown" style="min-width: 190px;">
                                                    ...
                                                    <?php endif; ?>
                                                    <li>
                                                        <!-- <a href="javascript:void(0)" onclick="deleteItem('OrderAdmin/deleteOrderPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                            <a href="#" class="btn-item-delete" data-url="OrderAdmin/deleteOrderPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_user', true); ?>">
