            ...
            <form action="<?= base_url('Admin/editFontPost'); ?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="font_name" value="<?= esc($font->font_name); ?>" placeholder="<?= trans("name"); ?>" maxlength="200" data-type="title" required>
                        <small>(E.g: Open Sans)</small>
                    </div>
                    <?php if (!$font->is_default && !$font->has_local_file): ?>
                        <div class="form-group">
                            <label class="control-label"><?= trans("url"); ?> </label>
                            <textarea name="font_url" class="form-control" data-type="url" placeholder="<?= trans("url"); ?>" required><?= $font->font_url; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="font_family" value="<?= esc($font->font_family); ?>" placeholder="<?= trans("font_family"); ?>" maxlength="500" data-type="text" required>
