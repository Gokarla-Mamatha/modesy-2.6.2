    ...
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= esc(trans("update_font")); ?></h3>
            </div>
            <form action="<?= base_url('Admin/editFontPost'); ?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="font_name" value="<?= esc($font->font_name); ?>" placeholder="<?= esc(trans("name")); ?>" maxlength="200" data-type="title" required>
                        <small>(E.g: Open Sans)</small>
                    </div>
                    <?php if (!$font->is_default && !$font->has_local_file): ?>
                        <div class="form-group">
                            <label class="control-label"><?= esc(trans("url")); ?> </label>
                            <textarea name="font_url" class="form-control" data-type="url" placeholder="<?= esc(trans("url")); ?>" required><?= $font->font_url; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="font_family" value="<?= esc($font->font_family); ?>" placeholder="<?= esc(trans("font_family")); ?>" maxlength="500" data-type="text" required>
