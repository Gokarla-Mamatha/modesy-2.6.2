    ...
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= esc(trans("update_language")); ?></h3>
            </div>
            <form action="<?= base_url('Language/editLanguagePost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="<?= esc(trans("language_name")); ?>" value="<?= esc($language->name); ?>" maxlength="200" data-type="name" required>
                        <small>(Ex: English)</small>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans("short_form")); ?> </label>
                        <input type="text" class="form-control" name="short_form" placeholder="<?= esc(trans("short_form")); ?>" value="<?= esc($language->short_form); ?>" maxlength="200" data-type="text" required>
                        <small>(Ex: en)</small>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans("language_code")); ?> </label>
                        <input type="text" class="form-control" name="language_code" placeholder="<?= esc(trans("language_code")); ?>" value="<?= esc($language->language_code); ?>" maxlength="200" data-type="text" required>
                        <small>(Ex: en_us)</small>
                    </div>
                    <div class="form-group">
                        <label><?= esc(trans('order')); ?></label>
                        <input type="number" class="form-control" name="language_order" placeholder="<?= esc(trans('order')); ?>" value="<?= esc($language->language_order); ?>" min="1" data-type="number" required>
                    </div>
                    <div class="form-group">
