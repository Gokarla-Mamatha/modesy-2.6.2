                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                <li>
                                                    <!-- <a href="javascript:void(0)" onclick="deleteItem('Product/deleteQuoteRequestPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"> -->
                                                     <a href="#" class="btn-item-delete" data-url="Product/deleteQuoteRequestPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">   
