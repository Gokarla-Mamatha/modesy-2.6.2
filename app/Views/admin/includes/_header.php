            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                if (hasPermission('productbid_requests')):?>
                    <li class="nav-productbid-requests">
                        <a href="<?= adminUrl('/product-bids'); ?>"><i class="fa fa-gavel"></i> <span><?= trans("Bidding Requests"); ?></span></a>
                    </li>
                <?php endif;
                ...
                if (hasPermission('membership')):?>
                    ...
                    <li class="treeview<?php isAdminNavActive(['users', 'membership-plans', 'shop-opening-requests', 'user-login-activities', 'account-deletion-requests']); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="nav-profile-activities"><a href="<?= adminUrl('profile-activities'); ?>"> <?= trans("User Profile Activities"); ?></a></li>
                ...
                <?php endif; ?>
                <li class="header hide li-mt"><?= trans("forums"); ?></li>
                  <li class="nav-categories">
                        <a href="<?= adminUrl('forums-categories'); ?>"><i class="fa fa-folder-open"></i> <span><?= trans("categories"); ?></span></a>
                    </li>
                 <li class="nav-categories">
