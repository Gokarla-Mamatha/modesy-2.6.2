                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-option">
                                            <a href="<?= base_url('invoice-membership/' . $item->id); ?>" class="btn btn-sm btn-default btn-edit" target="_blank"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?= esc(trans("view_invoice")); ?></a>
                                            <!-- <a href="javascript:void(0)" class="btn btn-default btn-delete" onclick="deleteItem('Admin/deleteMembershipPaymentPost','<?= $item->id; ?>','<?= esc(trans("confirm_delete")); ?>');"> -->
                                                <a href="#" class="btn-item-delete" data-url="Admin/deleteMembershipPaymentPost" data-id="<?= $item->id; ?>" data-msg="<?= esc(trans('confirm_delete', true)); ?>">
