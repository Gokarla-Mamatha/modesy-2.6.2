                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-option">
                                            ...
                                            <!-- <a href="javascript:void(0)" class="btn btn-default btn-delete" onclick="deleteItem('Admin/deleteMembershipPaymentPost','<?= $item->id; ?>','<?= trans("confirm_delete"); ?>');"> -->
                                                <a href="#" class="btn-item-delete" data-url="Admin/deleteMembershipPaymentPost" data-id="<?= $item->id; ?>" data-msg="<?= trans('confirm_delete', true); ?>">
