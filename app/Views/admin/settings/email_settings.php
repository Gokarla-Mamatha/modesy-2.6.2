                ...
                <div class="box-body">
                    ...
                    <?php if ($service == 'brevo'): ?>
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="brevo_api_key" placeholder="<?= trans('api_key'); ?>" value="<?= esc($emailSettings->brevo_api_key); ?>" data-type="password">
                        </div>
                    <?php elseif ($service == 'mailgun'): ?>
                        <div class="form-group">
                            <label class="control-label"><?= trans('api_key'); ?></label>
                            <input type="password" class="form-control" name="mailgun_api_key" placeholder="<?= trans('api_key'); ?>" value="<?= esc($emailSettings->mailgun_api_key); ?>" data-type="password">
                        </div>
                        <div class="form-group">
