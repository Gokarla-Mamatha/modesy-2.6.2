                ...
                <div class="tab-content settings-tab-content">
                    <div class="tab-pane<?= $activeTab == '1' ? ' active' : ''; ?>" id="tab_1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label><?= trans("coupon_products"); ?></label>
                ...
                <div class="box-body">
                    ...
                    <div id="formAwsS3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="aws_key" placeholder="<?= trans('access_key'); ?>" value="<?= esc($storageSettings->aws_key); ?>" data-type="apikey">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('secret_key'); ?></label>
                            <input type="text" class="form-control" name="aws_secret" placeholder="<?= trans('secret_key'); ?>" value="<?= esc($storageSettings->aws_secret); ?>" data-type="apikey">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('bucket_name'); ?></label>
                            <input type="text" class="form-control" name="aws_bucket" placeholder="<?= trans('bucket_name'); ?>" value="<?= esc($storageSettings->aws_bucket); ?>" data-type="text">
                        </div>
                        <div class="form-group">
                    ...
                    <div id="formCloudflareR2">
                        <div class="form-group">
                            <label class="control-label"><?= trans('access_key'); ?></label>
                            <input type="text" class="form-control" name="r2_key" placeholder="<?= trans('access_key'); ?>" value="<?= esc($storageSettings->r2_key); ?>" data-type="apikey">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('secret_key'); ?></label>
                            <input type="text" class="form-control" name="r2_secret" placeholder="<?= trans('secret_key'); ?>" value="<?= esc($storageSettings->r2_secret); ?>" data-type="apikey">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('bucket_name'); ?></label>
                            <input type="text" class="form-control" name="r2_bucket" placeholder="<?= trans('bucket_name'); ?>" value="<?= esc($storageSettings->r2_bucket); ?>" data-type="text">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('endpoint_url'); ?></label>
                            <input type="text" class="form-control" name="r2_endpoint_url" placeholder="<?= trans('endpoint_url'); ?>" value="<?= esc($storageSettings->r2_endpoint_url); ?>" data-type="url">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('public_url'); ?></label>
                            <input type="text" class="form-control" name="r2_public_url" placeholder="<?= trans('public_url'); ?>" value="<?= esc($storageSettings->r2_public_url); ?>" data-type="url">
                        </div>
                    </div>
                    ...
                    <div id="formBackblazeB2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="b2_key" placeholder="<?= trans("key_id"); ?>" value="<?= esc($storageSettings->b2_key); ?>" data-type="apikey">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('application_key'); ?></label>
                            <input type="text" class="form-control" name="b2_secret" placeholder="<?= trans('application_key'); ?>" value="<?= esc($storageSettings->b2_secret); ?>" data-type="apikey">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('bucket_name'); ?></label>
                            <input type="text" class="form-control" name="b2_bucket" placeholder="<?= trans('bucket_name'); ?>" value="<?= esc($storageSettings->b2_bucket); ?>" data-type="text">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('endpoint_url'); ?></label>
                            <input type="text" class="form-control" name="b2_endpoint_url" placeholder="<?= trans('endpoint_url'); ?>" value="<?= esc($storageSettings->b2_endpoint_url); ?>" data-type="url">
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= trans('public_url'); ?></label>
                            <input type="text" class="form-control" name="b2_public_url" placeholder="<?= trans('public_url'); ?>" value="<?= esc($storageSettings->b2_public_url); ?>" data-type="url">
                        </div>
                    </div>
            ...
            <form action="<?= base_url('Admin/aiWriterPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="api_key" placeholder="<?= trans('api_key'); ?>" value="<?= esc($aiWriter->apiKey); ?>" data-type="apikey" required>
                    </div>
                </div>
                <div class="box-footer">
                    <button type="submit" name="submit" value="post_deletion" class="btn btn-primary pull-right"><?= trans('save_changes'); ?></button>
