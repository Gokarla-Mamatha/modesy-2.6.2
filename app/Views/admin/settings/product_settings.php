<div class="row">
    <div class="col-sm-12 title-section">
        <h3><?= esc(trans('product_settings')); ?></h3>
    </div>
</div>
<div class="row">
        ...
        <form action="<?= base_url('Admin/productSettingsPost'); ?>" method="post">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= esc(trans('marketplace')); ?><br><small><?= esc(trans("add_product_for_sale")); ?></small></h3>
                </div>
                <div class="box-body" style="min-height: 320px;">
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans('product_options')); ?></label>
                        <?= formCheckbox('marketplace_variations', 1, trans('enable'), $productSettings->marketplace_variations); ?>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans('shipping')); ?></label>
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="marketplace" class="btn btn-primary pull-right"><?= esc(trans('save_changes')); ?></button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
        <form action="<?= base_url('Admin/productSettingsPost'); ?>" method="post">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= esc(trans('classified_ads')); ?><br><small><?= esc(trans("add_product_services_listing")); ?></small></h3>
                </div>
                <div class="box-body" style="min-height: 320px;">
                    <div class="form-group">
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="classified_ads" class="btn btn-primary pull-right"><?= esc(trans('save_changes')); ?></button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
        <form action="<?= base_url('Admin/productSettingsPost'); ?>" method="post">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= esc(trans('physical_products')); ?></h3>
                </div>
                <div class="box-body" style="min-height: 320px;">
                    <div class="form-group">
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="physical_products" class="btn btn-primary pull-right"><?= esc(trans('save_changes')); ?></button>
                </div>
            </div>
        </form>
    </div>
...
<div class="row">
    <div class="col-lg-4 col-md-12 col-sm-12">
        <form action="<?= base_url('Admin/productSettingsPost'); ?>" method="post">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= esc(trans('digital_products')); ?></h3>
                </div>
                <div class="box-body" style="min-height: 320px;">
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans('demo_url')); ?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans('external_download_link')); ?></label>
                        <?= formCheckbox('digital_external_link', 1, trans('enable'), $productSettings->digital_external_link); ?>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans('allowed_file_extensions')); ?></label>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <small>(<?= esc(trans('type_extension')); ?>&nbsp;E.g. zip, jpg, doc, pdf..)</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="box-footer">
                    <button type="submit" name="submit" value="digital_products" class="btn btn-primary pull-right"><?= esc(trans('save_changes')); ?></button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
        <form action="<?= base_url('Admin/productSettingsPost'); ?>" method="post">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= esc(trans('product_search_listing')); ?></h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans('pagination_product')); ?></label>
                        <input type="number" name="pagination_per_page" class="form-control max-700" value="<?= $productSettings->pagination_per_page; ?>" min="4" max="1000" data-type="number" required>
                    </div>
                </div>
                <div class="box-footer">
                    <button type="submit" name="submit" value="search_listing" class="btn btn-primary pull-right"><?= esc(trans('save_changes')); ?></button>
                </div>
            </div>
        </form>
    </div>
