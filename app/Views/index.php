...
<div id="wrapper" class="index-wrapper">
    <div class="container">
        <div class="row">
            ...
            echo view('product/_trending_products', ['trendingProducts' => $trendingProducts]);
            echo view('product/_coupon_offers', ['couponProducts' => $couponProducts]);
            echo view('forum/_forum_slider', ['categories' => $forumCategories]);
            ...
            if ($generalSettings->index_latest_products == 1 && !empty($latestProducts)): ?>
                <div class="col-12 section section-latest-products">
                    <div class="section-header display-flex justify-content-between">
                        <h3 class="title"><a href="<?= generateUrl('products'); ?>"><?= esc(trans("new_arrivals")); ?></a></h3>
            ...
            <?php if ($productSettings->brand_status == 1 && !empty($brands) && !empty($brands['brands'])): ?>
                <div class="col-12 section">
                    <div class="section-header">
                        <h3 class="title"><?= esc(trans("shop_by_brand")); ?></h3>
                    </div>
