<script src="<?= base_url('assets/admin/vendor/chart/chart.min.js'); ?>" <?= csp_script_nonce() ?>></script>
<script src="<?= base_url('assets/admin/vendor/chart/utils.js'); ?>" <?= csp_script_nonce() ?>></script>
<script src="<?= base_url('assets/admin/vendor/chart/analyser.js'); ?>" <?= csp_script_nonce() ?>></script>
