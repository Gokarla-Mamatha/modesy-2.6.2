                ...
                <div class="table-responsive">
                    <table class="table table-striped" role="grid">
                        ...
                        <tr role="row">
                            ...
                            <th scope="col"><?= esc(trans("membership_plan")); ?></th>
                            <th scope="col"><?= esc(trans("payment_amount")); ?></th>
                        ...
                        <?php if (!empty($transactions)):
                            foreach ($transactions as $transaction): ?>
                                <tr>
                                        ...
                                        <?php if ($transaction->payment_method == 'bank_transfer' && $transaction->payment_status == 'pending_payment'):
                                            ...
                                            if (!empty($lastBankTransfer)):
                                                if ($lastBankTransfer->status == 'pending'):
                                                    ...
                                                    <span class="text-primary">(<?= esc(trans("pending")); ?>)</span>
                                    ...
                                    <td><a href="<?= langBaseUrl('invoice-membership/' . $transaction->id); ?>" class="btn btn-sm btn-info" target="_blank"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?= esc(trans("view_invoice")); ?></a></td>
                                </tr>
                            <?php endforeach;
                        endif; ?>
                        </tbody>
