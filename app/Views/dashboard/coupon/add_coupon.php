                ...
                <form action="<?= base_url('add-coupon-post'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="text" name="coupon_code" id="input_coupon_code" value="<?= old("coupon_code"); ?>" class="form-control form-input" placeholder="<?= esc(trans("coupon_code")); ?>" maxlength="49" data-text="title" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="discount_rate" id="input_discount_rate" value="<?= old("discount_rate"); ?>" aria-describedby="basic-addon-discount" class="form-control form-input" placeholder="E.g: 5" min="0" max="99" data-text="decimal" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= esc(trans("number_of_coupons")); ?>&nbsp;<small>(<?= esc(trans("number_of_coupons_exp")); ?>)</small></label>
                        <input type="number" name="coupon_count" value="<?= old("coupon_count"); ?>" class="form-control form-input" placeholder="E.g: 100" min="1" max="99999999" data-text="number" required>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12 max-600">
                                ...
                                <div class='input-group date' id='datetimepicker'>
                                    <input type='text' class="form-control" name="expiry_date" value="<?= old("expiry_date"); ?>" placeholder="<?= esc(trans("expiry_date")); ?>" required>
                    ...
                    <div class="form-group text-right">
                        <button type="submit" name="submit" value="update" class="btn btn-md btn-success"><?= esc(trans("add_coupon")) ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<script src="<?= base_url('assets/vendor/bootstrap-datetimepicker/moment.min.js'); ?>" <?= csp_script_nonce() ?>></script>
<script src="<?= base_url('assets/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js'); ?>" <?= csp_script_nonce() ?>></script>
