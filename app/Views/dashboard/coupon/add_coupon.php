                ...
                <form action="<?= base_url('add-coupon-post'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="text" name="coupon_code" id="input_coupon_code" value="<?= old("coupon_code"); ?>" class="form-control form-input" placeholder="<?= trans("coupon_code"); ?>" maxlength="49" data-text="title" required>
