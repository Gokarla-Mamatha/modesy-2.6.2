<script src="https://cdnjs.cloudflare.com/ajax/libs/Sortable/1.15.0/Sortable.min.js" <?= csp_script_nonce() ?>></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/mdbassit/Coloris@latest/dist/coloris.min.css"/>
<script src="https://cdn.jsdelivr.net/gh/mdbassit/Coloris@latest/dist/coloris.min.js" <?= csp_script_nonce() ?>></script>
                               ...
                               <div class="modal-header d-flex justify-content-between align-items-center">
                                <div class="modal-header" style="padding:15px;">
                                    <div style="display: flex;justify-content: space-between;align-items: center;width: 100%;">
                                        <h4 class="modal-title mb-0" style="margin: 0;">Variant Coupons</h4>
                                        <button class="btn btn-primary" id="saveCouponsBtn" style="padding: 6px 14px;font-size: 14px;">Save Coupons</button>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <div id="couponRowsContainer"></div>
                                </div>
                                </div>
                            </div>
                        </div>
...
<script src="<?= base_url('assets/admin/js/product-options.js?v=' . time()); ?>" <?= csp_script_nonce() ?>></script>
