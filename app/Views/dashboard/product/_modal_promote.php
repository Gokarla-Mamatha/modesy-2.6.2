    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= esc(trans("promote_your_product")); ?></h4>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div id="pricingPlan_1" class="price-box">
                            <div class="pricing-name text-center">
                                <h4 class="name"><?= esc(trans("daily_plan")); ?></h4>
                            </div>
                            <div class="plan-price text-center">
                                <?php if ($paymentSettings->free_product_promotion == 1): ?>
                                    <h3><span class="price"><?= priceFormatted(0, $defaultCurrency->code); ?></span><span class="time">/<?= esc(trans("day")); ?></span></h3>
                                <?php else: ?>
                                    <h3><span class="price"><?= priceFormatted($paymentSettings->price_per_day, $defaultCurrency->code); ?></span><span class="time">/<?= esc(trans("day")); ?></span></h3>
                                <?php endif; ?>
                            </div>
                            <div class="price-features">
                                <p>
                                    ...
                                    <?= esc(trans("featured_badge")); ?>
                                </p>
                                <p>
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/>
                                    </svg>
                                    <?= esc(trans("appear_on_homepage")); ?>
                                </p>
                                <p>
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/>
                                    </svg>
                                    <?= esc(trans("show_first_search_lists")); ?>
                                </p>
                            </div>
                            <div class="text-center">
                                <a href="javascript:void(0)" class="btn btn-md btn-pricing-table" data-pricing-plan="pricingPlan_1"><?= esc(trans("choose_plan")); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div id="pricingPlan_2" class="price-box">
                            <div class="pricing-name text-center">
                                <h4 class="name"><?= esc(trans("monthly_plan")); ?></h4>
                            </div>
                            <div class="plan-price text-center">
                                <?php if ($paymentSettings->free_product_promotion == 1): ?>
                                    <h3><span class="price"><?= priceFormatted(0, $defaultCurrency->code); ?></span><span class="time">/<?= esc(trans("month")); ?></span></h3>
                                <?php else: ?>
                                    <h3><span class="price"><?= priceFormatted($paymentSettings->price_per_month, $defaultCurrency->code); ?></span><span class="time">/<?= esc(trans("month")); ?></span></h3>
                                <?php endif; ?>
                            </div>
                            <div class="price-features">
                                <p>
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0)" class="btn btn-md btn-pricing-table" data-pricing-plan="pricingPlan_2"><?= esc(trans("choose_plan")); ?></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <?php if ($paymentSettings->free_product_promotion != 1): ?>
                                <div class="form-group">
                                    <?php if ($defaultCurrency->symbol_direction == 'left'): ?>
                                        <strong class="price-total"><?= esc(trans("total_amount")); ?>&nbsp;<?= $defaultCurrency->symbol; ?><span class="span-price-total-daily"><?= esc($paymentSettings->price_per_day); ?></span>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php else: ?>
                                        <strong class="price-total"><?= esc(trans("total_amount")); ?>&nbsp;<span class="span-price-total-daily"><?= esc($paymentSettings->price_per_day); ?></span><?= $defaultCurrency->symbol; ?>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group m-0">
                                    <button type="submit" class="btn btn-lg btn-success"><?= esc(trans("continue_to_checkout")); ?></button>
                                </div>
                            <?php else: ?>
                                <div class="form-group m-0">
                                    <button type="submit" class="btn btn-lg btn-success"><?= esc(trans("submit")); ?></button>
                                </div>
                            <?php endif; ?>
                        </form>
                    </div>
                    ...
                    <div class="col-sm-12 container-pricing-plan" id="container_pricingPlan_2">
                        <form action="<?= base_url('promote-product-post'); ?>" method="post" onkeypress="return event.keyCode != 13;">
                            ...
                            <div class="form-group">
                                <label><?= esc(trans("month_count")); ?></label>
                            ...
                            <?php if ($paymentSettings->free_product_promotion != 1): ?>
                                <div class="form-group">
                                    <?php if ($defaultCurrency->symbol_direction == "left"): ?>
                                        <strong class="price-total"><?= esc(trans("total_amount")); ?>&nbsp;<?= $defaultCurrency->symbol; ?><span class="span-price-total-monthly"><?= esc($paymentSettings->price_per_month); ?></span>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php else: ?>
                                        <strong class="price-total"><?= esc(trans("total_amount")); ?>&nbsp;<span class="span-price-total-monthly"><?= esc($paymentSettings->price_per_month); ?></span><?= $defaultCurrency->symbol; ?>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group m-0">
                                    <button type="submit" class="btn btn-lg btn-success"><?= esc(trans("continue_to_checkout")); ?></button>
...
<script src="<?= base_url('assets/vendor/jquery-number/jquery.number.min.js'); ?>" <?= csp_script_nonce() ?>></script>
