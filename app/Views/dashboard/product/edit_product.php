                ...
                <form action="<?= base_url('edit-product-post'); ?>" method="post" id="form_validate" class="validate_price">
                    ...
                    <?php if (isAdmin() || hasPermission('products')): ?>
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control form-input" value="<?= esc($product->slug); ?>" placeholder="<?= trans("slug"); ?>" data-type="slug" maxlength="200">
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-bs-toggle="collapse" href="#collapse_<?= $language->id; ?>"><?= trans("details"); ?><?= countItems($activeLanguages) > 1 ? ':&nbsp;' . esc($language->name) : ''; ?>&nbsp;<?= selectedLangId() != $language->id ? '(' . trans("optional") . ')' : ''; ?><i class="fa fa-caret-down pull-right"></i></a>
                                        </h4>
                                    </div>
                                    <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= selectedLangId() == $language->id ? 'in' : ''; ?>">
                                        <div class="panel-body">
                                            <div class="form-group m-b-15">
                                                ...
                                                <input type="text" name="title_<?= $language->id; ?>" value="<?= !empty($productDetails) ? esc($productDetails->title) : ''; ?>" class="form-control form-input" placeholder="<?= trans("title"); ?>" <?= selectedLangId() == $language->id ? 'required' : ''; ?> maxlength="499" data-type="title">
                                            </div>
                                            <div class="form-group m-b-15">
                                                <label class="control-label"><?= trans("short_description"); ?></label>
                                                <input type="text" name="short_description_<?= $language->id; ?>" value="<?= !empty($productDetails) ? esc($productDetails->short_description) : ''; ?>" class="form-control form-input" placeholder="<?= trans("short_description"); ?>" maxlength="499" data-type="text">
                                            </div>
                                            <div class="form-group m-b-15">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <button type="button" id="btn_add_image_editor" class="btn btn-md btn-info m-b-10" data-editor-id="<?= $editorId; ?>" data-bs-toggle="modal" data-bs-target="#fileManagerModal"><i class="fa fa-image"></i>&nbsp;&nbsp;<?= trans("add_image"); ?></button>
                                                        <?php if (aiWriter()->status && hasPermission('ai_writer') && $editorId == 'editor_main'): ?>
                                                            <button type="button" class="btn btn-md btn-default btn-open-ai-writer m-b-10" data-bs-toggle="modal" data-bs-target="#modalAiWriter"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;<?= trans("ai_writer"); ?></button>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <textarea
...
<script src="https://cdn.ckeditor.com/ckeditor5/39.0.1/classic/ckeditor.js" <?= csp_script_nonce() ?>></script>
