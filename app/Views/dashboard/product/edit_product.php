                ...
                <form action="<?= base_url('edit-product-post'); ?>" method="post" id="form_validate" class="validate_price">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <?php if ($generalSettings->physical_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="product_type" value="physical" id="product_type_1" class="custom-control-input"
                                            <?= ($product->product_type == 'physical') ? 'checked' : ''; ?> required>
                            ...
                            <?php if ($generalSettings->digital_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="product_type" value="digital" id="product_type_2" class="custom-control-input"
                                            <?= ($product->product_type == 'digital') ? 'checked' : ''; ?> required>
                            ...
                            <div class="col-12 col-sm-6 col-custom-field">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="product_type" value="coupon" id="product_type_3" class="custom-control-input"
                                        <?= ($product->product_type == 'coupon') ? 'checked' : ''; ?> required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <?php if ($generalSettings->marketplace_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field listing_sell_on_site">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="listing_type_1" class="custom-control-label"><?= esc(trans('add_product_for_sale')); ?></label>
                            ...
                            <?php endif;
                            if ($generalSettings->productbid_system == 1 && $generalSettings->physical_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field listing_productbid">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="listing_type" value="productbid" id="listing_type_6" class="custom-control-input" <?= $product->listing_type == 'productbid' ? 'checked' : ''; ?> required>
                            ...
                            <div class="col-12 col-sm-6 col-custom-field listing_coupon">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="listing_type" value="coupon" id="listing_type_5" class="custom-control-input"
                                        <?= ($product->listing_type == 'coupon') ? 'checked' : ''; ?> required>
                    ...
                    <div class="form-group form-group-category">
                        ...
                        <div id="category_select_container">
                            <?php if (!empty($category)):
                                    ...
                                    if (!empty($parent)):
                                        ...
                                        if (!empty($subCategories)): ?>
                                            <div class="subcategory-select-container m-t-5" data-level="<?= $level; ?>">
                                                <select name="category_id[]" class="select2 form-control subcategory-select" data-level="<?= $level; ?>" data-lang-id="<?= selectedLangId(); ?>" <?= $level == 1 ? 'required' : ''; ?>>
                                                    <option value=""><?= esc(trans('select_category')); ?></option>
                                                    <?php foreach ($subCategories as $subCategory): ?>
                                                        <option value="<?= $subCategory->id; ?>" <?= $subCategory->id == $parent->id ? 'selected' : ''; ?>>
                                                            <?= esc($subCategory->cat_name); ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                ...
                                if (!empty($subCategories)): ?>
                                    <div class="subcategory-select-container m-t-5" data-level="<?= $level; ?>">
                                        <select name="category_id[]" class="select2 form-control subcategory-select" data-level="<?= $level; ?>" data-lang-id="<?= selectedLangId(); ?>">
                                            <option value=""><?= esc(trans('select_category')); ?></option>
                                            <?php foreach ($subCategories as $subCategory): ?>
                                ...
                                <div class="subcategory-select-container m-t-5" data-level="1">
                                    <select id="categories" name="category_id[]" class="select2 form-control subcategory-select" data-level="1" data-lang-id="<?= selectedLangId(); ?>" required>
                                        <option value=""><?= esc(trans('select_category')); ?></option>
                    ...
                    <?php if (isAdmin() || hasPermission('products')): ?>
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control form-input" value="<?= esc($product->slug); ?>" placeholder="<?= esc(trans("slug")); ?>" data-type="slug" maxlength="200">
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="is_sold" class="form-control custom-select" required>
                                        <option value="0" <?= $product->is_sold != 1 ? 'selected' : ''; ?>><?= esc(trans('active')); ?></option>
                                        <option value="1" <?= $product->is_sold == 1 ? 'selected' : ''; ?>><?= esc(trans('sold')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="visibility" class="form-control custom-select" required>
                                        <option value="1" <?= $product->visibility == 1 ? 'selected' : ''; ?>><?= esc(trans('visible')); ?></option>
                                        <option value="0" <?= $product->visibility == 0 ? 'selected' : ''; ?>><?= esc(trans('hidden')); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="commission_mode" id="commission_mode" class="form-control select2">
                                        <option value="default" <?= $product->is_commission_set == 0 ? 'selected' : ''; ?>><?= esc(trans("default")); ?></option>
                                        <option value="custom" <?= $product->is_commission_set == 1 && $product->commission_rate > 0 ? 'selected' : ''; ?>><?= esc(trans("custom")); ?></option>
                                        <option value="none" <?= $product->is_commission_set == 1 && $product->commission_rate == 0 ? 'selected' : ''; ?>><?= esc(trans("none")); ?> (0%)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group" id="custom_commission_input" style="<?= $product->is_commission_set == 1 && $product->commission_rate > 0 ? '' : 'display: none;'; ?>">
                                    ...
                                    <input type="number" name="commission_rate" id="commission_rate" class="form-control" min="0" max="99.99" step="0.01" value="<?= $product->commission_rate > 0 ? esc(formatDecimalClean($product->commission_rate)) : ''; ?>" placeholder="E.g. 5" data-type="decimal">
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-bs-toggle="collapse" href="#collapse_<?= $language->id; ?>"><?= esc(trans("details")); ?><?= countItems($activeLanguages) > 1 ? ':&nbsp;' . esc($language->name) : ''; ?>&nbsp;<?= selectedLangId() != $language->id ? '(' . trans("optional") . ')' : ''; ?><i class="fa fa-caret-down pull-right"></i></a>
                                        </h4>
                                    </div>
                                    <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= selectedLangId() == $language->id ? 'in' : ''; ?>">
                                        <div class="panel-body">
                                            <div class="form-group m-b-15">
                                                ...
                                                <input type="text" name="title_<?= $language->id; ?>" value="<?= !empty($productDetails) ? esc($productDetails->title) : ''; ?>" class="form-control form-input" placeholder="<?= esc(trans("title")); ?>" <?= selectedLangId() == $language->id ? 'required' : ''; ?> maxlength="499" data-type="title">
                                            </div>
                                            <div class="form-group m-b-15">
                                                <label class="control-label"><?= esc(trans("short_description")); ?></label>
                                                <input type="text" name="short_description_<?= $language->id; ?>" value="<?= !empty($productDetails) ? esc($productDetails->short_description) : ''; ?>" class="form-control form-input" placeholder="<?= esc(trans("short_description")); ?>" maxlength="499" data-type="text">
                                            </div>
                                            <div class="form-group m-b-15">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <button type="button" id="btn_add_image_editor" class="btn btn-md btn-info m-b-10" data-editor-id="<?= $editorId; ?>" data-bs-toggle="modal" data-bs-target="#fileManagerModal"><i class="fa fa-image"></i>&nbsp;&nbsp;<?= esc(trans("add_image")); ?></button>
                                                        <?php if (aiWriter()->status && hasPermission('ai_writer') && $editorId == 'editor_main'): ?>
                                                            <button type="button" class="btn btn-md btn-default btn-open-ai-writer m-b-10" data-bs-toggle="modal" data-bs-target="#modalAiWriter"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;<?= esc(trans("ai_writer")); ?></button>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <textarea
                                                    ...
                                                    id="<?= $editorId; ?>"
                                                    class="tinyMCE text-editor">
                                                 <?= !empty($productDetails) ? esc($productDetails->description) : ''; ?>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 m-t-30 buttons-product-form">
                            ...
                            <?php else: ?>
                                <a href="<?= generateDashUrl('product', 'product_details') . '/' . $product->id; ?>" class="btn btn-lg btn-primary pull-right"><?= esc(trans("edit_details")); ?>&nbsp;&nbsp;<i class="fa fa-long-arrow-right"></i> </a>
                                <button type="submit" class="btn btn-lg btn-success pull-right m-r-10"><i class="fa fa-check"></i>&nbsp;&nbsp;<?= esc(trans("save_changes")); ?></button>
                            <?php endif; ?>
                        </div>
                    </div>
                </form>
