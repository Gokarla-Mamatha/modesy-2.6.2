                ...
                <form action="<?= base_url('add-product-post'); ?>" method="post" id="form_validate">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group form-group-category">
                        ...
                        <select id="categories" name="category_id[]" class="select2 form-control subcategory-select m-0" data-level="1" data-lang-id="<?= selectedLangId(); ?>" required>
                    ...
                    <script <?= csp_script_nonce() ?>>
                        window.MdsCategoryTree = <?= json_encode($categoryTree ?? [], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
                    </script>
                    <!-- <div class="form-group">
                                    ...
                                    <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= selectedLangId() == $language->id ? 'in' : ''; ?>">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group m-b-15">
                                                ...
                                                <textarea name="description_<?= $language->id; ?>" id="<?= $editorId; ?>" class="tinyMCE text-editor" data-type="text"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
