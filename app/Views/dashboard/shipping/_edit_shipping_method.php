                                                ...
                                                <div class="rate-row-inner">
                                                    <div class="rate-input">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" name="rates[<?= $i ?>][min_weight]" value="<?= esc($rate->min_weight) ?>" class="form-control" placeholder="<?= trans("min_weight") ?>" min="0" max="999999" step="0.001" data-type="decimal">
                                                        </div>
                                                    </div>
                                                    <div class="rate-input">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><?= trans("kg"); ?></span>
                                                            <input type="number" name="rates[<?= $i ?>][max_weight]" value="<?= esc($rate->max_weight) ?>" class="form-control" placeholder="<?= trans("max_weight") ?>" min="0" max="999999" step="0.001" data-type="decimal">
                                                        </div>
                                                    </div>
                                                    <div class="rate-input">
                                                        <div class="input-group">
