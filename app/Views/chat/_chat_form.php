<?php if (!empty($chat)): ?>
    <div id="formChat">
        ...
        <?php endif; ?>
        <input type="text" name="message" id="inputChatMessage" class="form-control" placeholder="<?= esc(trans('write_a_message')); ?>" autocomplete="off" onkeypress="if(event.keyCode === 13){sendChatMessage()};">
...
<?php else: ?>
    <input type="text" name="message" class="form-control" placeholder="<?= esc(trans('write_a_message')); ?>" autocomplete="off" required>
