            ...
            <div class="flex-item flex-item-center">
                ...
                <p class="p-last-seen">
                    <?php if (isUserOnline($profile->last_seen)): ?>
                        <span class="last-seen last-seen-online"> <i class="icon-circle"></i> <?= esc(trans("online")); ?></span>
                    <?php else: ?>
                        <span class="last-seen"> <i class="icon-circle"></i> <?= esc(trans("offline")); ?></span>
                    <?php endif; ?>
                </p>
            </div>
            <div class="flex-item flex-shrink-0">
                <button type="button" class="btn btn-chat-delete js-delete-chat" data-chat-id="<?= esc($chat->id, 'attr'); ?>" data-msg="<?= esc(trans("confirm_message", true), 'attr'); ?>">
