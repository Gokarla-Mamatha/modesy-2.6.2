<div class="sidebar-tabs">
    ...
    <a class="nav-link" href="<?= generateUrl("settings", "business_details"); ?>">
        <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="24" viewBox="0 0 24 24" fill="none">   
                <path d="M3 21H21" stroke="#333333"  stroke-width="2"  stroke-linecap="round"/> <path d="M5 21V7C5 6.44772 5.44772 6 6 6H10C10.5523 6 11 6.44772 11 7V21"  stroke="#333333"  stroke-width="2"/>
                <path d="M13 21V3C13 2.44772 13.4477 2 14 2H18C18.5523 2 19 2.44772 19 3V21"  stroke="#333333"  stroke-width="2"/> <path d="M7 10H9" stroke="#333333" stroke-width="2" stroke-linecap="round"/> <path d="M7 14H9" stroke="#333333" stroke-width="2" stroke-linecap="round"/> <path d="M15 6H17" stroke="#333333" stroke-width="2" stroke-linecap="round"/> <path d="M15 10H17" stroke="#333333" stroke-width="2" stroke-linecap="round"/> <path d="M15 14H17" stroke="#333333" stroke-width="2" stroke-linecap="round"/>
            </svg>
        </div>
