                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12 col-md-6 m-b-sm-15">
                                ...
                                <input type="text" name="first_name" class="form-control form-input" placeholder="<?= trans("first_name"); ?>" maxlength="250" data-type="name" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="control-label"><?= trans("last_name"); ?></label>
                                <input type="text" name="last_name" class="form-control form-input" placeholder="<?= trans("last_name"); ?>" maxlength="250" data-type="name" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12 col-md-6 m-b-sm-15">
                                ...
                                <input type="email" name="email" class="form-control form-input" placeholder="<?= trans("email"); ?>" maxlength="250" data-type="email" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="control-label"><?= trans("phone_number"); ?></label>
                                <input type="text" name="phone_number" class="form-control form-input" placeholder="<?= trans("phone_number"); ?>" maxlength="100" data-type="mobile" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-dialog modal-dialog-shipping-address">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('edit-shipping-address-post'); ?>" method="post" id="form_edit_shipping_address_<?= $address->id; ?>" class="validate-form">
                        ...
                        <div class="modal-footer text-right">
                           <button type="submit" class="btn btn-md btn-custom btn-save-edit-address" data-state-select="select_states_address_<?= $address->id; ?>"> <?= trans("save_changes"); ?></button>
                        </div>
                    </form>
                </div>
            </div>
