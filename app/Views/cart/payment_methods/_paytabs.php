<?php if (!empty($paymentGateway) && $paymentGateway->name_key == 'paytabs' && !empty($paytabsCheckoutUrl)): ?>
    <div id="payment-button-container" class="payment-button-cnt">
        ...
        <a href="<?= base_url('payment/process/' . $checkout->id); ?>" class="btn btn-lg btn-payment" style="background-color: #1A73E8; border-color: #1A73E8; color: #fff;">
