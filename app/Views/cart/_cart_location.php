<form action="<?= base_url('cart/payment-method-post'); ?>" method="post" id="form_validate">
    ...
    <?php if ($generalSettings->single_country_mode != 1): ?>
        <div class="m-b-5">
                <select id="select_countries_cart" name="country_id" class="select2 select2-req form-control"  required>
    ...
    <div class="form-group m-t-30 text-right">
        <button type="submit" name="submit" value="location" class="btn btn-lg btn-custom btn-continue-payment"><?= esc(trans("continue_to_payment")) ?>&nbsp;&nbsp;<i class="icon-arrow-right m-0"></i></button>
    </div>
