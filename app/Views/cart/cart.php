                            ...
                            <div class="col-sm-12 col-lg-4">
                                <div class="right">
                                    <div class="row-custom m-b-15">
                                        <!-- <strong><?= trans("subtotal"); ?><span class="float-right"><?= priceDecimal($total, $cart->currency_code); ?></span></strong> -->
                                    ...
                                    <div class="row-custom m-b-10">
                                        <!-- <strong><?= trans("total"); ?><span class="float-right"><?= priceDecimal($total, $cart->currency_code); ?></span></strong> -->
                                    ...
                                    <form action="<?= base_url('cart/coupon-code-post'); ?>" method="post" id="form_validate" class="m-0">
                                        ...
                                        <div class="cart-discount-coupon">
                                            <input type="text" name="coupon_code" class="form-control form-input" value="<?= esc(old('coupon_code')); ?>" maxlength="254" placeholder="<?= trans("coupon_code") ?>" required data-type="text">
