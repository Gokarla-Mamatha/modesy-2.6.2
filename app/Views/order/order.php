                ...
                <div class="col-12">
                    <nav class="nav-breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= generateUrl('orders'); ?>"><?= esc(trans("orders")); ?></a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="order-head">
                            <div class="row justify-content-center align-items-center row-title">
                                <div class="col-12 col-sm-6">
                                    <h1 class="page-title m-b-5"><?= esc(trans("order")); ?>:&nbsp;#<?= esc($order->order_number); ?></h1>
                                </div>
                                <div class="col-12 col-sm-6">
                                            ...
                                            <?php else: ?>
                                                <?php if (!$isThereShippedProductOrder):
                                                    if ($order->payment_method != "cash_on_delivery" || ($order->payment_method == 'cash_on_delivery' && dateDifferenceInHours(date('Y-m-d H:i:s'), $order->created_at) <= 24)): ?>
                                                        <button type="button" class="btn btn-light m-b-5 js-cancel-order" data-order-id="<?= esc($order->id, 'attr'); ?>" data-msg="<?= esc(trans("confirm_action", true), 'attr'); ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
                                                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                                                                <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                                                            </svg>&nbsp;&nbsp;<?= esc(trans("cancel_order")); ?></button>
                                                    <?php endif;
                                                endif;
                                            endif;
                                        endif; ?>
                                ...
                                <div class="col-12">
                                    <div class="row order-row-item">
                                        <div class="col-12 col-sm-3">
                                            <b class="font-600"><?= esc(trans("status")); ?></b>
                                        </div>
                                        <div class="col-12 col-sm-9">
                                            ...
                                            <?php else: ?>
                                                <span class="badge badge-primary-light"><?= esc(trans("order_processing")); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row order-row-item">
                                        <div class="col-12 col-sm-3">
                                            <b class="font-600"><?= esc(trans("payment_method")); ?></b>
                                        </div>
                                        <div class="col-12 col-sm-9">
                                    ...
                                    <?php if ($order->status != 2): ?>
                                        <div class="row order-row-item">
                                            <div class="col-12 col-sm-3">
                                                <b class="font-600"><?= esc(trans("payment_status")); ?></b>
                                            </div>
                                            <div class="col-12 col-sm-9">
                                                <?= esc(trans($order->payment_status)); ?>

                                                <?php if ($lastBankTransferStatus == 'pending'): ?>
                                                    <span class="text-info">(<?= esc(trans("pending")); ?>)</span>
                                                <?php elseif ($lastBankTransferStatus == 'declined'): ?>
                                                    <span class="text-danger">(<?= esc(trans("bank_transfer_declined")); ?>)</span>
                                                <?php endif; ?>
                                    ...
                                    <?php if ($order->payment_method == 'bank_transfer'): ?>
                                        <div class="row order-row-item">
                                            <div class="col-12 col-sm-3">
                                                <b class="font-600"><?= esc(trans("transaction_number")); ?></b>
                                            </div>
                                            <div class="col-12 col-sm-9">
                                    ...
                                    <div class="row order-row-item">
                                        <div class="col-12 col-sm-3">
                                            <b class="font-600"><?= esc(trans("date")); ?></b>
                                        </div>
                                        <div class="col-12 col-sm-9">
                                    ...
                                    <div class="row order-row-item">
                                        <div class="col-12 col-sm-3">
                                            <b class="font-600"><?= esc(trans("updated")); ?></b>
                                        </div>
                                        <div class="col-12 col-sm-9">
                                                ...
                                                <div class="d-flex flex-wrap gap-10">
                                                    ...
                                                    <?php if ($lastBankTransferStatus !== 'pending'): ?>
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#reportBankTransferModal">
                                                            ...
                                                            </svg>&nbsp;&nbsp;<?= esc(trans("report_bank_transfer")); ?>
                                                        </button>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            ...
                                            if (!empty($orderProducts)):
                                                foreach ($orderProducts as $item):
                                                    ...
                                                    <tr>
                                                                ...
                                                                <div class="right">
                                                                    <div class="m-b-10">
                                                                        <div class="badge badge-info-light">
                                                                            ...
                                                                            if (!empty($seller)): ?>
                                                                                <?= esc(trans("seller")); ?>:&nbsp;<a href="<?= generateProfileUrl($seller->slug); ?>"><?= esc(getUsername($seller)); ?></a>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="m-b-10">
                                                                    ...
                                                                    <div class="product-variant-info m-b-15">
                                                                        <?php if ($item->product_type == 'coupon'): ?>
                                                                            <div class="item">
                                                                                <strong class="info-left">Coupons:</strong><br>

                                                                                <?php if (!empty($coupons)): ?>
                                                                                    <?php foreach ($coupons as $c): ?>
                                                                                        <div class="badge badge-success-light m-t-5">
                                                                                            <?= esc($c->coupon_code); ?>
                                                                                        </div><br>
                                                                                    <?php endforeach; ?>
                                                                                <?php else: ?>
                                                                                    <div class="text-danger">No coupon assigned</div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                        <?php endif; ?>

                                                                        <div class="item">
                                                                            <strong class="info-left"><?= esc(trans("sku")); ?>:</strong>&nbsp;<?= esc(getOrderSku($item)); ?>
                                                                        </div>
                                                                        <?php if (!empty($item->product_vat) && $item->product_vat > 0): ?>
                                                                            <div class="item">
                                                                                <strong class="info-left"><?= esc(trans("vat")); ?>:</strong>&nbsp;<?= $item->product_vat_rate; ?>%&nbsp;(<?= priceFormatted($item->product_vat, $item->product_currency); ?>)
                                                                            </div>
                                                                        <?php endif; ?>
                                                                        <div class="item">
                                                                            <strong class="info-left"><?= esc(trans("quantity")); ?>:</strong>&nbsp;<?= $item->product_quantity; ?>
                                                                        </div>
                                                                        <div class="item">
                                                                            <strong class="info-left"><?= esc(trans("price")); ?>:</strong>&nbsp;<?= priceFormatted($item->product_unit_price, $item->product_currency); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td style="width: 10%">
                                                            <strong class="no-wrap"><?= esc(trans($item->order_status)) ?></strong>
                                                            ...
                                                            <div class="order-shipping-tracking-number">
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <div class="flex-item text-center">
                                                                        <?php if ($item->order_status == 'shipped'): ?>
                                                                            <div>
                                                                                <button type="button" class="btn btn-md btn-custom js-approve-order-product" data-item-id="<?= esc($item->id, 'attr'); ?>" data-msg="<?= esc(trans("confirm_approve_order", true), 'attr'); ?>"><i class="icon-check"></i><?= esc(trans("confirm_order_received")); ?></button>
                                                                            </div>
                                                                            <small class="text-muted"><?= esc(trans("confirm_order_received_exp")); ?></small>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="order-total">
                                        ...
                                        if (!empty($affiliate) && !empty($affiliate['discount']) && $affiliate['discount'] > 0): ?>
                                            <div class="row">
                                                <div class="col-6 col-left">
                                                    <?= esc(trans("referral_discount")); ?>&nbsp;(<?= $affiliate['discountRate']; ?>%)
                                                </div>
                                                <div class="col-6 col-right">
                                        ...
                                        if (!empty($order->transaction_fee) && $order->transaction_fee > 0): ?>
                                            <div class="row">
                                                <div class="col-6 col-left">
                                                    <?= esc(trans("transaction_fee")); ?><?= $order->transaction_fee_rate ? ' (' . $order->transaction_fee_rate . '%)' : ''; ?>
                                                </div>
                                                <div class="col-6 col-right">
                    ...
                    <?php if ($order->payment_method != 'cash_on_delivery' || $order->payment_status == 'payment_received'):
                        if (!empty($shipping)): ?>
                            <p class="text-confirm-order">*<?= esc(trans("confirm_order_received_warning")); ?></p>
                        <?php endif;
                    endif;
                    if (!$isThereShippedProductOrder):
                        if ($order->payment_method == 'cash_on_delivery' && dateDifferenceInHours(date('Y-m-d H:i:s'), $order->created_at) <= 24):
                            if ($order->status == 0):?>
                                <p class="text-confirm-order text-danger">*<?= esc(trans("cod_cancel_exp")); ?></p>
                            <?php endif;
                        endif;
                    endif; ?>
                </div>
