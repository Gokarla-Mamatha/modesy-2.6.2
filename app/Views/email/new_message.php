                    ...
                    <td>
                        ...
                        <div class="mailcontent" style="line-height: 26px;font-size: 14px;">
                            <p style='text-align: left;margin-bottom: 10px;'>
                                <strong style="font-weight: 600;"><?= esc(trans("user")); ?></strong>:&nbsp;<?= !empty($emailData['messageSender']) ? esc($emailData['messageSender']) : ''; ?>
                            </p>
                            <p style='text-align: left;margin-bottom: 10px;'>
                                <strong style="font-weight: 600;"><?= esc(trans("subject")); ?></strong>:&nbsp;<?= !empty($emailData['messageSubject']) ? esc($emailData['messageSubject']) : ''; ?>
                            </p>
                            <p style='text-align: left;margin-bottom: 10px;'>
                                <strong style="font-weight: 600;"><?= esc(trans("message")); ?></strong>:<br><?= !empty($emailData['messageText']) ? esc($emailData['messageText']) : ''; ?>
                            </p>
                        </div>
