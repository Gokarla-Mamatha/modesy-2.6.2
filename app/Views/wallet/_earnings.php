    ...
    <div class="table-responsive table-custom">
        <table class="table">
            ...
            <tr role="row">
                ...
                <th scope="col"><?= esc(trans("vat")); ?></th>
                <th scope="col"><?= esc(trans("commissions_discounts")); ?></th>
                <th scope="col"><?= esc(trans("shipping_cost")); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="font-size-13">
                                <?= esc(trans("commission")); ?>:&nbsp;<span class="text-danger"><?= priceFormatted($earning->commission, $earning->currency); ?>&nbsp;<?= !empty($earning->commission_rate) ? '(' . $earning->commission_rate . '%)' : ''; ?></span>
                            </div>
                            <?php if (!empty($earning->affiliate_commission)): ?>
                                <div class="font-size-13 m-t-5">
                                    <?= esc(trans("referrer_commission")); ?>:&nbsp;<span class="text-danger"><?= priceFormatted($earning->affiliate_commission, $earning->currency); ?>&nbsp;(<?= $earning->affiliate_commission_rate; ?>%)</span>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($earning->affiliate_discount)): ?>
                                <div class="font-size-13 m-t-5">
                                    <?= esc(trans("referral_discount")); ?>:&nbsp;<span class="text-danger"><?= priceFormatted($earning->affiliate_discount, $earning->currency); ?>&nbsp;(<?= $earning->affiliate_discount_rate; ?>%)</span>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($earning->coupon_discount)): ?>
                                <div class="font-size-13 m-t-5">
                                    <?= esc(trans("discount_coupon")); ?>:&nbsp;<span class="text-danger"><?= priceFormatted($earning->coupon_discount, $earning->currency); ?></span>
                        ...
                        <td>
                            <?php if (!empty($order) && $order->payment_method == 'cash_on_delivery'): ?>
                                <span class="text-danger"><?= esc(trans("cash_on_delivery")); ?></span>
                            <?php else: ?>
                                ...
                                <?php if ($paymentSettings->currency_converter == 1 && $earning->exchange_rate > 0 && $earning->exchange_rate != 1):
                                    $totalEarned = numToDecimal($earning->earned_amount);
                            ...
                            if ($earning->is_refunded == 1): ?>
                                <br><span class="text-danger">(<?= esc(trans("refund")); ?>)</span>
                            <?php endif; ?>
                        </td>
