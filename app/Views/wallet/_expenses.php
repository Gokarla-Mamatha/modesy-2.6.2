<div class="wallet-container wallet-container-table">
    <div class="table-responsive table-custom">
        <table class="table">
            <thead>
            <tr role="row">
                <th scope="col"><?= esc(trans("payment_id")); ?></th>
                <th scope="col"><?= esc(trans("expense")); ?></th>
                <th scope="col"><?= esc(trans("expense_amount")); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($expense->expense_type == 'sale'): ?>
                                <?= esc(trans("purchase")); ?>&nbsp;(<?= trans("order") . ' #' . esc($expense->expense_item_id); ?>)
                            <?php elseif ($expense->expense_type == 'membership'): ?>
                                <?= esc(trans("membership_plan")); ?>&nbsp;(<?= esc($expense->expense_detail); ?>)
                        ...
                        <td class="no-wrap"><?= formatDate($expense->created_at); ?>
                            <?php if ($expense->expense_type == 'sale'): ?>
                                <div><a href="<?= langBaseUrl('invoice/' . esc($expense->expense_item_id)); ?>?type=buyer" class="text-info link-underlined" target="_blank"><?= esc(trans("view_invoice")); ?></a></div>
                            <?php elseif ($expense->expense_type == 'membership'): ?>
                                <div><a href="<?= langBaseUrl('invoice-membership/' . esc($expense->expense_item_id)); ?>" class="text-info link-underlined" target="_blank"><?= esc(trans("view_invoice")); ?></a></div>
                            <?php elseif ($expense->expense_type == 'commission_debt'): ?>
                                <div><a href="<?= langBaseUrl('invoice-expense/' . esc($expense->id)); ?>" class="text-info link-underlined" target="_blank"><?= esc(trans("view_invoice")); ?></a></div>
                            <?php elseif ($expense->expense_type == 'promote'): ?>
                                <div><a href="<?= langBaseUrl('invoice-promotion/' . esc($expense->expense_item_id)); ?>" class="text-info link-underlined" target="_blank"><?= esc(trans("view_invoice")); ?></a></div>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach;
