            ...
            <div class="col-12">
                <div class="sidebar-tabs-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                           <?php 
                            if ($activeTab == 'referral_earnings') {
                            ...
                            } elseif ($activeTab == 'loyalty_points') {
                                echo view("wallet/_loyalty_points");  
                            } elseif ($activeTab == 'redeem-history') {
                                echo view("wallet/_redeem_history");
                            }else {
