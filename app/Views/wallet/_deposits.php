    ...
    <div class="table-responsive table-custom">
        <table class="table">
            ...
            <tr role="row">
                ...
                <th scope="col"><?= esc(trans("payment_method")); ?></th>
                <th scope="col"><?= esc(trans("deposit_amount")); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else:
                                ...
                                <?= priceCurrencyFormat($deposit->deposit_amount, $deposit->currency); ?>&nbsp;(<?= $deposit->currency; ?>)&nbsp;-&nbsp;<?= esc(trans("pending_payment")); ?><br>
                                ...
                                if (!empty($lastBankTransfer)):
                                    ...
                                    <?php elseif ($lastBankTransfer->status == 'declined'): ?>
                                        <span class="text-danger">(<?= esc(trans("bank_transfer_declined")); ?>)</span><br>
                                    <?php endif; ?>
                                <?php endif;
                                if ($showReportButton):?>
                        ...
                        <td class="no-wrap">
                            ...
                            <div><a href="<?= langBaseUrl('invoice-wallet-deposit/' . $deposit->id); ?>" class="text-info link-underlined" target="_blank"><?= esc(trans("view_invoice")); ?></a></div>
                        </td>
                    </tr>
                <?php endforeach;
            endif; ?>
