                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= esc(trans("invoice")); ?>:</span>#INVM<?= $transaction->id; ?></p>
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= esc(trans("payment_status")); ?>:</span><?= $transaction->payment_status == 'pending_payment' ? trans("pending_payment") : trans("payment_received"); ?></p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-0 font-weight-bold"><?= esc(trans("membership_plan")); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr style="font-size: 15px;">
                                            <td><?= esc(trans("membership_plan_payment")); ?></td>
...
<script src="<?= base_url('assets/js/jquery-3.5.1.min.js'); ?>" <?= csp_script_nonce() ?>></script>
