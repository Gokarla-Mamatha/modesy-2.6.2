                    ...
                    <div class="row">
                        <div class="col-md-3 hide-mobile">
                            <div class="all-help-topics">
                                <a href="<?= generateUrl('help_center'); ?>"><i class="icon-angle-left"></i>&nbsp;<?= esc(trans("all_help_topics")); ?></a>
                            </div>
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="need-more-help need-more-help-article">
                                <h3 class="title"><?= esc(trans("still_have_questions")); ?></h3>
                                <span class="text-muted"><?= esc(trans("still_have_questions_exp")); ?></span>
