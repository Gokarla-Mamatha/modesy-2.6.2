                ...
                <div class="support">
                    <nav class="nav-breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?= esc(trans("help_center")); ?></li>
                        </ol>
                    </nav>
                    <h1 class="page-title main-title"><strong><?= esc(trans("how_can_we_help")); ?></strong></h1>
                    <div class="row">
                        <div class="col-12">
                            <div class="search-container">
                                <div class="search">
                                    <form action="<?= generateUrl('help_center', 'search'); ?>" method="get">
                                        <input type="text" name="q" class="form-control form-input" placeholder="<?= esc(trans("search")); ?>" required>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="need-more-help">
                                <h3 class="title"><?= esc(trans("need_more_help")); ?></h3>
                                <span class="text-muted"><?= esc(trans("contact_support_exp")); ?></span>
