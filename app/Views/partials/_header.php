                                ...
                                <div class="col-md-5 nav-top-right">
                                    <ul class="nav align-items-center">
                                        ...
                                        <?php if (authCheck()): ?>
                                            ...
                                            <?php if ($generalSettings->multi_vendor_system == 1): ?>
                                                <li class="nav-item m-r-0">
                                                    <button type="button" class="btn btn-md btn-custom btn-sell-now m-r-0" data-bs-toggle="modal" data-target="#loginModal" onclick="handleSellNowClick()" aria-label="sell-now"><?= esc(trans("sell_now")); ?></button>
                                                </li>
                                        <?php endif;
                                        endif; ?>
                                    </ul>
