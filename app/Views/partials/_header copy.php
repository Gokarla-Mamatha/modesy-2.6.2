...
<head>
    ...
    <?php endif; ?>
    <?php if (function_exists('generateAlternateTags')): ?>
        <?= generateAlternateTags($isTranslatable ?? false); ?>
    <?php endif; ?>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LeeGlssAAAAAMWjMFQb_7KmUOHDAqv5osBZzi7i" <?= csp_script_nonce() ?>></script>
</head>
