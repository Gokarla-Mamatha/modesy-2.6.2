        ...
        <div class="modal-content modal-custom">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <textarea name="review" id="reviewText" class="form-control form-input form-textarea m-b-5" rows="4" placeholder="<?= trans("write_review"); ?>" data-type="text"required></textarea>
