    ...
    <div class="row">
        <div class="col-12">
            <div class="review-total">
                <?php if (!empty($reviews) && $reviewsCount > 0): ?>
            ...
            <div class="modal-content modal-custom">
                <form id="form_report_review" method="post">
                    <div class="modal-header">
                        <h2 class="modal-title"><?= esc(trans("report_review")); ?></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group m-0">
                                    ...
                                    <textarea name="description" class="form-control form-textarea" data-type="text" placeholder="<?= esc(trans("abuse_report_exp")); ?>" minlength="5" maxlength="<?= REVIEW_CHARACTER_LIMIT; ?>" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
