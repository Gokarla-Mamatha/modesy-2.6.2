                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group m-0">
                                    ...
                                    <textarea name="description" class="form-control form-textarea" data-type="text" placeholder="<?= trans("abuse_report_exp"); ?>" minlength="5" maxlength="<?= REVIEW_CHARACTER_LIMIT; ?>" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
