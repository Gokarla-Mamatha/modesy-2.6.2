                ...
                <div class="row">
                    <div class="col-12">
                      ...
                      <ul class="nav nav-tabs nav-tabs-horizontal mb-5" id="productTabs">
                            <li class="nav-item">
                                <a class="nav-link" href="#about_section"><?= trans("About"); ?></a>
                            </li>
                            <?php if (!empty($product->coupon_description)): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#need_to_know_section"><?= trans("need_to_know_info"); ?></a>
                            </li>
                            <?php endif; ?>
                            <?php if (!empty($product->coupon_redeem_place)): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#where_to_redeem_section"><?= trans("where_to_redeem"); ?></a>
                            </li>
                            <?php endif; ?>
                            <?php if ($generalSettings->reviews == 1): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#reviews_section"><?= trans("reviews"); ?> (<?= $reviewsCount; ?>)</a>
                            </li>
                            <?php endif; ?>

                            <?php if ($generalSettings->product_comments == 1): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#comments_section"><?= trans("comments"); ?> (<?= $commentsCount; ?>)</a>
                            </li>
                            <?php endif; ?>
                      </ul>
                        ...
                        <div class="product-description post-text-responsive">
                            ...
                            <div id="need_to_know_section" class="mb-5">
                                <h4 class="font-weight-bold mb-4 text-primary"><?= trans("need_to_know_info"); ?></h4>
                                <div class="description">
                            ...
                            <div id="where_to_redeem_section" class="mb-5">
                                ...
                                <h4 class="font-weight-bold mb-4 text-primary"><?= trans("where_to_redeem"); ?></h4>
                           ...
                           <!-- ADDITIONAL INFORMATION -->
                            ...
                            <div id="additional_information_section" class="mb-5">
                                <h4 class="font-weight-bold mb-4 text-primary"><?= trans("additional_information"); ?></h4>
                            ...
                            <div id="reviews_section" class="mb-2">
                                <h4 class="font-weight-bold mb-2" style="color: #e76528;">
                                    <?= trans("reviews"); ?> (<?= $reviewsCount; ?>)
                                </h4>
                                <div id="review-result"><?= view('product/details/_reviews'); ?></div>
                            </div>
                            <?php endif; ?>
                            <!-- COMMENTS -->
                            <?php if ($generalSettings->product_comments == 1): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group m-0">
                                    ...
                                    <textarea name="description" class="form-control form-textarea" data-type="text" placeholder="<?= trans("abuse_report_exp"); ?>" minlength="5" maxlength="10000" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
