        ...
        <div class="form-add-comment">
            ...
            <form id="formAddComment">
                ...
                <div class="form-group">
                    <textarea name="comment" id="comment_text" class="form-control form-input form-textarea" placeholder="<?= trans("comment"); ?>..." maxlength="<?= COMMENT_CHARACTER_LIMIT; ?>" data-type="text"></textarea>
                </div>
