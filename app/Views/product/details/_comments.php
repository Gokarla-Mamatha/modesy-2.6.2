                    ...
                    <div class="col-12">
                        <div class="comments">
                            <?php if (empty($parentComments)): ?>
                                <p class="no-comments-found"><?= esc(trans("no_comments_found")); ?></p>
                            <?php endif; ?>
...
<div class="row">
    <div class="col-12">
        <div class="form-add-comment">
            <label class="font-600 m-b-15"><?= esc(trans("add_comment")); ?></label>
                ...
                <?php if (!authCheck()): ?>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <input type="text" name="name" class="form-control form-input" placeholder="<?= esc(trans("name")); ?>" maxlength="255">
                        </div>
                        <div class="form-group col-md-6">
                            <input type="email" name="email" class="form-control form-input" placeholder="<?= esc(trans("email_address")); ?>" maxlength="255">
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-group">
                    <textarea name="comment" id="comment_text" class="form-control form-input form-textarea" placeholder="<?= esc(trans("comment")); ?>..." maxlength="<?= COMMENT_CHARACTER_LIMIT; ?>" data-type="text"></textarea>
                </div>

                <?= view('partials/_cf_turnstile'); ?>

                <div class="form-group text-right">
                    <button type="submit" class="btn btn-md btn-custom"><?= esc(trans("post_comment")); ?></button>
                </div>
            </form>
        </div>
    </div>
