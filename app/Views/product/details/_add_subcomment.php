<form id="formAddSubcomment<?= $parentComment->id; ?>">
    <div class="form-group">
        <textarea name="comment" class="form-control form-input form-textarea form-comment-text" data-type="text" placeholder="<?= trans("comment"); ?>" maxlength="<?= COMMENT_CHARACTER_LIMIT; ?>"></textarea>
    </div>
