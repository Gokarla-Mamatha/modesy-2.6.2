...
$routes->get('forum/category/(:any)', 'ForumController::category/$1');
$routes->get('forum/thread/(:any)', 'ForumController::thread/$1');
$routes->get('forum/create-thread/(:any)', 'ForumController::createThread/$1');
$routes->post('forum/submit-thread', 'ForumController::submitThread');
$routes->post('forum/reply/(:num)', 'ForumController::reply/$1');
$routes->post('forum/react-post', 'ForumController::reactPost');
$routes->post('forum/moderate-post/(:num)', 'ForumController::moderatePost/$1');
$routes->get('forum/mark-solution/(:num)', 'ForumController::markSolution/$1');
$routes->get('forum/post-reactions/(:num)/(:alpha)', 'ForumController::postReactions/$1/$2');
$routes->get('forum/forum-search', 'ForumController::forumSearch');
$routes->post('forum/delete-post', 'ForumController::deletePost');
...
$routes->post('ajax/loyalty/convert', 'LoyaltyController::convert');
$routes->post('(:segment)/ajax/loyalty/convert', 'LoyaltyController::convert');
...
$routes->get('coupons', 'CouponController::coupons');
$routes->post('coupon/apply', 'CouponController::applyCoupon');
$routes->get('captcha/math', 'CaptchaController::math');
/*tax collection
 */
...
$routes->get($rtAdmin .  '/product-bids', 'ProductController::productBids');
$routes->post($rtAdmin . '/delete-bidding', 'Product::deleteBidPost');
//category
...
$routes->get($rtAdmin . '/profile-activities', 'MembershipController::profileActivities');
...
$routes->post('bidding/place-bid', 'OrderController::placeBidPost');
$routes->get('bids', 'OrderController::productBids');
...
$routes->get('payment/process/(:num)', 'CheckoutController::process/$1');
...
$routes->get('csrf-token', 'ProfileController::csrfToken');
$routes->post('add-shipping-address-post', 'ProfileController::addShippingAddressPost');
$routes->post('delete-shipping-address-post', 'ProfileController::deleteShippingAddressPost');
...
$routes->get($rtAdmin . '/edit-forums-category/(:num)', 'AdminForumCategoryController::editCategory/$1');
$routes->get($rtAdmin . '/forums-threads', 'AdminForumController::adminThreads');
$routes->get($rtAdmin . '/forums-thread/(:num)', 'AdminForumController::threadReplies/$1');
$routes->get($rtAdmin . '/lock-thread/(:num)', 'AdminForumController::toggleLock/$1');
$routes->get($rtAdmin . '/edit-thread/(:num)', 'AdminForumController::editThread/$1');
$routes->post($rtAdmin . '/edit-thread-post', 'AdminForumController::editThreadPost');
...
$postArray = [
    ...
    //forums
    'AdminForumCategory/addCategoryPost',
    'AdminForumCategory/deleteCategoryPost',
    'AdminForumCategory/deleteCategoryImagePost',
    'AdminForumCategory/editCategoryPost',
    'AdminForum/editThreadPost',
    'AdminForum/deleteThreadPost',
...
if (!empty($languages)) {
    foreach ($languages as $language) {
        ...
        $routes->get($key . $csrt->settings . '/' . $csrt->business_details, 'ProfileController::businessDetails');
        ...
        //forums
        $routes->get($key . $csrt->threads, 'AdminForumController::threads');
        $routes->get($key . $csrt->edit_thread . '/(:num)', 'AdminForumController::editThread/$1');
        $routes->post($key . $csrt->edit_thread_post, 'AdminForumController::editThreadPost');
        $routes->get($key . $csrt->delete_thread . '/(:num)', 'AdminForumController::deleteThread/$1');
        //product
        ...
        $routes->get($key . $csrt->productbid_requests, 'OrderController::productBids');
        $routes->post($key . $csrt->dashboard . '/accept-bid', 'DashboardController::acceptBidPost');
        $routes->post($key . $csrt->dashboard . '/deleteBid', 'DashboardController::deleteBid');
        //terms & conditions
        ...
        $routes->get($key . $csrt->dashboard . '/' . $csrt->productbid_requests, 'DashboardController::productBids');
        ...
        $routes->get($key . $csrt->dashboard . '/' . $csrt->threads, 'AdminForumController::threads');
        $routes->get($key . $csrt->dashboard . '/' . $csrt->edit_thread . '/(:num)', 'AdminForumController::editThread/$1');
        $routes->post($key . $csrt->dashboard . '/' . $csrt->edit_thread_post, 'AdminForumController::editThreadPost');
        $routes->get($key . $csrt->dashboard . '/' . $csrt->delete_thread . '/(:num)', 'AdminForumController::deleteThread/$1');
...
// $routes->match(['GET', 'POST'], 'home/setDefaultLocationPost', 'HomeController::setDefaultLocationPost');
