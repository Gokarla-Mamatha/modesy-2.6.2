    ...
    public array $globals = [
        'before' => [
            ...
            'csrf' => [
                ...
                'login-post',   
                'admin/login-post',
                'ajax/loyalty/convert',
                '(:segment)/ajax/loyalty/convert',
                ...
                'earnings/convert-loyalty-wallet',
                'Ajax/getStates',
                'Ajax/getCities',
                ...
                'cart/add-to-cart',
                'home/select-membership-plan-post',
                'cart/update-quantity',
                'Ajax/getSubCategories',
                'dashboard/get-sub-categories',
